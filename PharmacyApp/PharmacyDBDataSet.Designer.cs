...
namespace PharmacyApp {
    ...
    public partial class PharmacyDBDataSet : global::System.Data.DataSet {
        ...
        public partial class SalesDataTable : global::System.Data.TypedTableBase<SalesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SalesRow AddSalesRow(int MedicineID, int QuantitySold, System.DateTime SaleDate) {
...
namespace PharmacyApp.PharmacyDBDataSetTableAdapters {
    ...
    public partial class SalesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Sales] WHERE (([SaleID] = @Original_SaleID) AND ([MedicineID] " +
                "= @Original_MedicineID) AND ([QuantitySold] = @Original_QuantitySold) AND ([Sale" +
                "Date] = @Original_SaleDate))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sales] SET [MedicineID] = @MedicineID, [QuantitySold] = @QuantitySold, [SaleDate] = @SaleDate WHERE (([SaleID] = @Original_SaleID) AND ([MedicineID] = @Original_MedicineID) AND ([QuantitySold] = @Original_QuantitySold) AND ([SaleDate] = @Original_SaleDate));
SELECT SaleID, MedicineID, QuantitySold, SaleDate FROM Sales WHERE (SaleID = @SaleID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PharmacyApp.Properties.Settings.Default.PharmacyDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_SaleID, int Original_MedicineID, int Original_QuantitySold, System.DateTime Original_SaleDate) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_QuantitySold));
        ...
        public virtual int Insert(int MedicineID, int QuantitySold, System.DateTime SaleDate) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(MedicineID));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(QuantitySold));
        ...
        public virtual int Update(int MedicineID, int QuantitySold, System.DateTime SaleDate, int Original_SaleID, int Original_MedicineID, int Original_QuantitySold, System.DateTime Original_SaleDate, int SaleID) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(MedicineID));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(QuantitySold));
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_QuantitySold));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MedicineID, int QuantitySold, System.DateTime SaleDate, int Original_SaleID, int Original_MedicineID, int Original_QuantitySold, System.DateTime Original_SaleDate) {
